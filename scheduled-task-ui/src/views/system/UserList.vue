...
import { pageUser, createUser, updateUser, deleteUser, assignUserRoles, listRole } from '@/api/system'
...
<template>
  <div class="page-card"
    ...
    <div class="table-toolbar"
      >
      <el-button type="primary" v-permission="'system:user'" @click="openForm()">新增用户</el-button>
    </div>
    ...
    <el-table v-loading="loading" :data="records" border stripe
      ...
      <el-table-column label="操作" width="160" fixed="right"
        ...
        <template #default="{ row }"
          >
            <el-button link type="primary" v-permission="'system:user'" @click="openForm(row)"
              >编辑</el-button>
            <el-button link type="danger" v-permission="'system:user'" @click="handleDelete(row)"
              >删除</el-button>
          </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="formVisible" :title="formId ? '编辑用户' : '新增用户'" width="500px"
      >
