...
import { pageDatasource, deleteDatasource, testDatasource } from '@/api/datasource'
...
<template>
  <div class="page-card">
    ...
    <div class="table-toolbar"
      >
      <el-button type="primary" v-permission="'datasource:create'" @click="handleCreate"
        >新增数据源</el-button>
    </div>
    ...
    <el-table v-loading="loading" :data="records" border stripe
      ...
      <el-table-column label="操作" width="220" fixed="right"
        >
        <template #default="{ row }">
          <el-button link type="primary" v-permission="'datasource:edit'" @click="handleEdit(row)"
            >编辑</el-button>
          <el-button link type="success" v-permission="'datasource:edit'" @click="handleTest(row)"
            >测试</el-button>
          <el-button link type="danger" v-permission="'datasource:delete'" @click="handleDelete(row)"
            >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <DatasourceForm v-model:visible="formVisible" :id="formId" @success="onFormSuccess" />
  </div>
</template>
