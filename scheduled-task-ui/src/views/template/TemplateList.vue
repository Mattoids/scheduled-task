...
const handleUpload = async () => {
  if (!uploadForm.file || !uploadForm.templateName || !uploadForm.templateCode) {
  ...
  <div class="page-card"
    ...
    <BaseSearchForm @search="handleSearch" @reset="handleReset"
      ...
      <el-form-item label="模板名称"
        >
        <el-input v-model="queryForm.templateName" placeholder="模板名称" clearable />
      </el-form-item>
    </BaseSearchForm>

    <div class="table-toolbar"
      >
      <el-button type="primary" v-permission="'template:create'" @click="uploadVisible = true"
        >上传模板</el-button>
    </div>
    ...
    <el-table v-loading="loading" :data="records" border stripe
      ...
      <el-table-column label="操作" width="120" fixed="right"
        ...
        <template #default="{ row }"
          >
            <el-button link type="danger" v-permission="'template:delete'" @click="handleDelete(row)"
              >删除</el-button>
          </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="uploadVisible" title="上传模板" width="500px"
      >
      <el-form label-width="100px"
        ...
        <el-form-item label="描述"
          >
          <el-input v-model="uploadForm.description" type="textarea" :rows="2" placeholder="描述" />
        </el-form-item>
        <el-form-item label="模板文件"
          ...
          >
            ...
            <template #tip>
              <div class="el-upload__tip">支持 Excel / Word / PPT / CSV / TXT</div>
            </template>
          </el-upload>
        </el-form-item>
      </el-form>
